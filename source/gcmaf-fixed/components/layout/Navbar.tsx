...
const CONTACT_URL = 'https://gcmaf.net/contact'
  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
        {/* Logo */}
        <Link href={`${SITE_URL}/`} onClick={closeNavigation} className="flex items-center gap-2 group">
          <Image src="/images/logo-transparent-bg.png" alt="GcMAF Logo" width={40} height={40} className="w-10 h-10 object-contain transition-transform duration-300 group-hover:scale-105" />

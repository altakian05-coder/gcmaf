  ...
  return (
    <>
      ...
      <section className="py-32 relative overflow-hidden flex items-center justify-center">
        <Image src="/images/chronic-infections/hepatitis-bg.webp" alt="Hepatitis B & C" fill className="object-cover absolute inset-0 brightness-50" />
      ...
      {/* Tuberculosis Banner */}
      <section className="py-32 relative overflow-hidden flex items-center justify-center">
        <Image src="/images/chronic-infections/tuberculosis-bg.webp" alt="Tuberculosis Background" fill className="object-cover absolute inset-0 brightness-50" />

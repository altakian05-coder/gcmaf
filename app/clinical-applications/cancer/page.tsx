  ...
  return (
    <>
      ...
      <section className="py-32 relative overflow-hidden flex items-center justify-center">
        <Image src="/images/cancer/effective-recovery-bg.webp" alt="Effective Recovery Banner" unoptimized fill className="object-cover absolute inset-0 brightness-50" />
